...
function AmazonLogo() {
  return (
    <svg
      ...
      viewBox="0 0 150 31"
    >
      <path d="M19.418 9.56c-.084-2.13-.97-3.777-2.473-4.926C15.273 3.484 13.628 3 12.01 3 7.968 3 4.582 6.392 4.582 10.44c0 1.82.621 3.426 1.676 4.726l-1.128 3.392a.75.75 0 00.938.938l3.392-1.128c1.3 1.055 2.906 1.676 4.726 1.676 4.048 0 7.44-3.385 7.44-7.428 0-.103-.002-.205-.008-.307zm-7.408 6.865c-1.344 0-2.621-.438-3.665-1.238a.75.75 0 00-.672-.123l-2.025.674.674-2.025a.75.75 0 00-.123-.672c-.8-1.044-1.238-2.32-1.238-3.665 0-3.344 2.715-6.06 6.06-6.06 1.623 0 3.18.634 4.345 1.785 1.17 1.157 1.785 2.72 1.785 4.345 0 3.345-2.716 6.06-6.06 6.06zm3.75-5.25h-3v-3a.75.75 0 00-1.5 0v3.75c0 .414.336.75.75.75h3.75a.75.75 0 000-1.5z"/>
    </svg>
  );
}
